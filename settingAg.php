        ...
        echo "
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    Toast.fire({
                    icon: 'success',
                    title: 'Data sosmed berhasil diubah!'
                    });    
        ...
        echo "
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    Toast.fire({
                    icon: 'info',
                    title: 'Data sosmed tidak diubah!'
                    });    
                });
            </script>
        ";
        ...
        echo "
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    Toast.fire({
                    icon: 'error',
                    title: 'Data Sosmed gagal diubah!'
                    });    
                    ...
                    <div class="form-main-content">
                        <div class="flex justify-between w-100">
                            ...
                            <div class="basis-5/6 flex flex-col gap-3">
                                ...
                                <div class="flex items-end gap-5">
                                    ...
                                    <div class="agent-data w-2/4">
                                        <input class="w-full" type="text" name="lastname" placeholder="Last Name"
                                            value="<?= $lastname ?>">
                                    </div>
                                </div>
                                ...
                                <div class="agent-data flex flex-col">
                                    ...
                                    <input type="text" name="nohp" placeholder="Your Phone Number..."
                                        value="<?= $agent['no_hp'] ?>">
                                </div>
                            </div>
                            <!-- upload image -->
                            <div class="basis-3/12 flex flex-col p-5 ms-5 bg-gray-200 rounded-md">
                                <div class="relative">
                                    <img class="w-full" src="assets/fotoUploads/<?= $agent['foto'] ?>" alt=""
                                        id="gam_settings">
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="agent-data flex flex-col">
                                ...
                                <input type="text" name="title" placeholder="Your title, proffesion or small biography"
                                    id="title" value="<?= $agent['title'] ?>">
                            </div>
                            <div class="agent-data flex flex-col">
                                <label for="biography">Biography</label>
                                <textarea name="biography" id="" cols="30"
                                    rows="5"><?= $agent['biography'] ?></textarea>
                            </div>
                        </div>
